document.addEventListener('DOMContentLoaded', () => {
    ...
    // Toggle login link visibility based on authentication status
    ...
    if (searchInput) {
        searchInput.addEventListener('input', async (e) => {
            ...
            users.forEach(user => {
                ...
                userDiv.innerHTML = `
                    <p><img src="${user.photo}" alt="${user.name}" width="100"></p>
                    <h3>${user.name}</h3>
        ...
        .then(requests => {
            ...
            requests.forEach(request => {
                ...
                requestDiv.innerHTML = `
                    <p><img src="${request.photo}" alt="${request.name}" width="100"></p>
                    <h3>${request.name}</h3>
